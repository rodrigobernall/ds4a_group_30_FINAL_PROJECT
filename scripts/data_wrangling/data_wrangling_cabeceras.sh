...
PGPASSWORD=$DB_PASS_FINAL_30 psql -h $DB_HOST_FINAL_30 -d $DB_NAME_FINAL_30 -U $DB_USER_FINAL_30 -c "\\copy personas FROM cabecera_personas_concat.csv CSV DELIMITER ';' NULL ' '"
